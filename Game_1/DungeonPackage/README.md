...
- `Door.py` defines a door within a room. A door is an immovable object that lets a user navigate from one room to another using a connection by touching it with their character.
